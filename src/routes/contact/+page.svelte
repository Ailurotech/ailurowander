...
<svelte:head>
  ...
  <meta
    name="description"
    content="Get in touch with AiluroWander for your Asian travel inquiries."
  />
</svelte:head>
...
<Section title={$t('contact.form.title')} subtitle={$t('contact.form.subtitle')} background="white">
  <div class="grid md:grid-cols-2 gap-16">
    ...
    <div class="space-y-12">
      <Card
        ...
        description={$t('contact.info.subtitle')}
      ...
      >
        <div class="mt-8 space-y-6">
          <div class="flex items-center">
            ...
            <span class="text-lg">{$t('contact.info.phone')}</span>
          </div>
          <div class="flex items-center">
            <div class="mr-4">
              <ChineseIcon icon="temple" size="md" color="#B91C1C" />
            </div>
            <span class="text-lg">{$t('contact.info.hours')}</span>
          </div>
          <a
      ...
      <Card
        title={$t('contact.why_contact.title')}
        description={$t('contact.why_contact.subtitle')}
      ...
      >
        <ul class="mt-8 space-y-4">
          <li class="flex items-start">
            ...
            <span class="text-lg">{$t('contact.why_contact.points.customize')}</span>
          </li>
          <li class="flex items-start">
            <span class="text-primary mr-3">✦</span>
            <span class="text-lg">{$t('contact.why_contact.points.questions')}</span>
          </li>
          <li class="flex items-start">
            <span class="text-primary mr-3">✦</span>
            <span class="text-lg">{$t('contact.why_contact.points.requests')}</span>
          </li>
          <li class="flex items-start">
            <span class="text-primary mr-3">✦</span>
            <span class="text-lg">{$t('contact.why_contact.points.groups')}</span>
          </li>
        </ul>
      </Card>
    </div>
