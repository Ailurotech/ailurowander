<script lang="ts">
  ...
  type ChineseIconType = 'great-wall' | 'forbidden-city' | 'terracotta' | 
  ...
  async function deleteTour() {
    ...
    try {
      ...
      deleteError = error instanceof Error ? error.message : 'Failed to delete tour. Please try again.';
    }
  }
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10">
                      {#if tour.iconType}
                        <ChineseIcon icon={tour.iconType} size="lg" color={tour.isActive ? '#B91C1C' : '#9CA3AF'} />
                      {:else}
                    ...
                    <div class="ml-4">
                      ...
                      <div class="text-sm text-neutral-500 truncate max-w-xs">{tour.description}</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
