  ...
  <div class="min-h-screen bg-neutral-50 flex flex-col">
      ...
      <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <div class="flex items-center space-x-8">
          ...
          <nav class="hidden md:flex space-x-6">
            <a
              href="/agent/tours"
              class="hover:text-white/80 {$page.url.pathname.startsWith('/agent/tours')
                ? 'font-bold border-b-2 border-white/70'
                : ''}"
            >
              Tours
            </a>
            <a
              href="/agent/bookings"
              class="hover:text-white/80 {$page.url.pathname.startsWith('/agent/bookings')
                ? 'font-bold border-b-2 border-white/70'
                : ''}"
            >
              Bookings
            ...
            <a
              ...
              class="hover:text-white/80 {$page.url.pathname.startsWith('/agent/customers')
                ? 'font-bold border-b-2 border-white/70'
                : ''}"
            >
              Customers
            ...
            <a
              href="/agent/users"
              class="hover:text-white/80 {$page.url.pathname.startsWith('/agent/users')
                ? 'font-bold border-b-2 border-white/70'
                : ''}"
            >
              Users
    ...
    <div class="bg-primary-dark text-white md:hidden">
      <div class="container mx-auto px-4 py-2 flex justify-between overflow-x-auto">
        <a
          href="/agent/tours"
          class="whitespace-nowrap px-3 py-1 rounded-md {$page.url.pathname.startsWith(
            '/agent/tours'
          )
