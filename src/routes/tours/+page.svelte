  ...
  >
      ...
      <form class="flex flex-col md:flex-row gap-4 max-w-2xl mx-auto" on:submit={handleSearch}>
        ...
        {#if searchQuery}
          <button 
            ...
            on:click={() => { searchQuery = ''; loadTours(); }}
          >
            {$t('tours.page.clear')}
          </button>
        {/if}
    ...
    {#if isLoading}
      <div class="text-center py-12">
        <div class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-primary hover:bg-primary-dark transition ease-in-out duration-150 cursor-not-allowed">
