...
>
  ...
  <div
    ...
    style="background-image: url({image}); background-size: cover; background-position: center; background-repeat: no-repeat; transform: translateY({scrollY *
      0.3}px);"
  ></div>
  ...
  {#if decorative}
    ...
    <div class="absolute top-0 right-0 w-32 h-32 opacity-30">
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M60,0 L100,0 L100,40 L90,40 L90,10 L60,10 Z"
          fill="currentColor"
          class="text-white"
        />
      </svg>
    ...
    <div class="absolute bottom-0 left-0 w-32 h-32 opacity-30">
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M0,60 L0,100 L40,100 L40,90 L10,90 L10,60 Z"
          fill="currentColor"
          class="text-white"
        />
      </svg>
    ...
    <div class="absolute bottom-0 right-0 w-32 h-32 opacity-30">
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M60,90 L60,100 L100,100 L100,60 L90,60 L90,90 Z"
          fill="currentColor"
          class="text-white"
        />
      </svg>
        ...
        <div class="flex flex-wrap gap-4 mt-8 justify-center">
          {#if primaryCta}
            <a
              ...
              class="bannerButton hover:scale-105 transition-transform duration-300"
            >
              {primaryCta.text}
            </a>
          {/if}
