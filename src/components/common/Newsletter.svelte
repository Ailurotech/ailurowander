<script lang="ts">
  ...
  export let placeholderText: string = $t('home.newsletter.placeholder');
  export let background: string = '#541212';
</script>

<section class="py-16 text-white" style="background-color: {background};">
  <div class="container">
