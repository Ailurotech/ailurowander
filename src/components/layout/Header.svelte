    ...
    <div class="flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center space-x-4">
        ...
        <div class="relative">
          ...
          >
            <span
              class="w-5 h-5 rounded-full overflow-hidden flex items-center justify-center bg-white/20"
            >
              {#if $locale === 'en'}
                🇬🇧
              {:else if $locale === 'zh'}
      ...
      <nav class="md:hidden py-4 border-t border-white/20 mt-3 space-y-3">
        ...
        <div class="pt-3 border-t border-white/20">
          ...
          <div class="flex flex-wrap gap-2">
            {#each supportedLanguages as lang}
              <button
                class="flex items-center space-x-1 rounded-full bg-white/10 px-2 py-1 hover:bg-white/20 {$locale ===
                lang.code
